module seamNFT::seam_pass_nft{
    ...
    fun init_module(account:&signer){
        let collection_name = string::utf8(b"Seam Pass");
        let collection_description = string::utf8(b"The Seam Pass is a utility NFT");
        let baseuri = string::utf8(b"https://gateway.pinata.cloud/ipfs/QmcVxumHiLwCr9hD6VyhpRuMM17BndsE5ab6nTipMD84qG");
        let royalty_payee_address = @royalties;
        let royalty_points_denominator: u64 = 7; 
        ...
        move_to<SeamPass>(&resource_signer_from_cap, SeamPass{
            collection_name,
